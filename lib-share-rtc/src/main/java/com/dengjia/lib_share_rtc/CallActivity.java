package com.dengjia.lib_share_rtc;
...
import com.dengjia.lib_share_rtc.signal.SignalClient;
...
public class CallActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SignalClient.getInstance().joinRoom("https://www.xycloud.cloud", "123456");
    }
    ...
    public PeerConnection createPeerConnection() {
        ...
        PeerConnection.IceServer ice_server =
                    PeerConnection.IceServer.builder("turn:stun.l.xycloud.cloud:3478")
                                            .setPassword("dengjia")
                                            .setUsername("dengjia")
                                            .createIceServer();
    ...
    private void logcatOnUI(final String msg) {
        Log.i(TAG, msg);
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
